...
This project is indexed by GitNexus as **cftc** (1522 symbols, 4076 relationships, 119 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/cftc/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/cftc/context` | Codebase overview, check index freshness |
| `gitnexus://repo/cftc/clusters` | All functional areas |
| `gitnexus://repo/cftc/processes` | All execution flows |
| `gitnexus://repo/cftc/process/{name}` | Step-by-step execution trace |
