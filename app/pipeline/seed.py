...
STAGE_TEMPLATES = [
    ...
    # stage_order starts at 3 so Kanban shows: Concept(1) → Drafting(2) → Final Rule Dev(3)
    ("rulemaking", "final_rule", 3, "drafting", "Final Rule Development", "#6b7280", 0, 30),
    ("rulemaking", "final_rule", 4, "cba_development", "CBA Development", "#8b5cf6", 0, 21),
    ("rulemaking", "final_rule", 5, "chairman_review", "Chairman Review", "#f59e0b", 0, 14),
    ("rulemaking", "final_rule", 6, "commission_review", "Commission Review/Vote", "#f59e0b", 0, 21),
    ("rulemaking", "final_rule", 7, "ofr_submission", "OFR Submission", "#3b82f6", 0, 7),
    ("rulemaking", "final_rule", 8, "published", "Published", "#22c55e", 1, None),
