...
export const getProjectByPipelineItem = (pipelineItemId) =>
  fetchJSON(`${W}/projects/by-pipeline-item/${pipelineItemId}`);
...
export const updateNote = (id, data) =>
  fetchJSON(`${W}/notes/${id}`, { method: "PATCH", body: JSON.stringify(data) });

export const listUnprocessedNotes = () =>
  fetchJSON(`${W}/notes/unprocessed`);
