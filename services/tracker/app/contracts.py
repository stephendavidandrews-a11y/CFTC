...
ENUMS = {
    ...
    "regulatory_stage": [
        ...
        "petition_received", "interpretive_release",
    ],
    ...
    "matter_dependency_type": [
        ...
        "supersedes", "joint_action",
    ],
    "comment_period_type": [
        "original", "extension", "reopening", "supplemental",
        "anprm", "nprm", "proposed_order", "concept_release",
        "final_rule_with_comment", "pra_60_day", "pra_30_day",
    ],
    ...
    "comment_topic_area": [
        "core_principles", "public_interest", "market_structure",
        "disclosure", "documentation", "registration",
        "special_entity", "clearing", "margin",
        "reporting", "surveillance", "position_limits",
        "cost_benefit", "definitional", "jurisdictional",
        "technology", "consumer_protection", "political_contributions",
        "procedural", "other",
    ],
    "comment_topic_position_status": [
        "open", "research", "draft_position", "under_review",
        "final", "deferred", "not_applicable",
    ],
    "comment_topic_source_document_type": [
        "anprm", "nprm", "final_rule_with_comment", "proposed_order",
        "concept_release", "interpretive_release", "guidance",
        "external_rulemaking",
    ],
    ...
    "directive_priority_tier": [
        ...
        "possible_legislation", "longer_term", "other",
    ],
    "directive_responsible_entity": [
        "cftc", "sec", "cftc_and_sec", "treasury", "occ", "fdic",
        "ncua", "fincen", "congress", "multiple_agencies", "other",
    ],
    "directive_ogc_role": [
        "drafter", "reviewer", "advisor", "commenter", "monitoring", "not_involved",
    ],
    "directive_implementation_status": [
        "not_started", "scoping", "in_progress",
