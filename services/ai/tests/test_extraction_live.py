...
MOCK_TRACKER_CONTEXT = {
    "matters": [
        {
            ...
            "stakeholders": [
                {
                    "full_name": "Alan Brubaker",
                    "person_id": "3de8efd0-dae8-4738-afbd-3019b91408ea",
                    "role": "owner",
                },
                {
                    "full_name": "Mel Gunewardena",
                    "person_id": "b55038c7-8f8d-44ed-bad3-a26b85b0e5be",
                    "role": "advisor",
                },
            ],
            "organizations": [
            ...
            "open_tasks": [
                {
                    "id": "task-001",
                    "title": "Review Kalshi court decision impact",
                    "status": "in progress",
                },
            ],
            "recent_updates": [],
    ...
    "people": [
        {
            "id": "3de8efd0-dae8-4738-afbd-3019b91408ea",
            "full_name": "Alan Brubaker",
            "title": "Director",
        },
        {
            "id": "b55038c7-8f8d-44ed-bad3-a26b85b0e5be",
            "full_name": "Mel Gunewardena",
            "title": "Senior Markets Advisor / Director OIA",
        },
        {
            "id": "f9c9048c-e23c-410e-9ed0-0d57fca0ee31",
            "full_name": "Michael S. Selig",
            "title": "Chairman",
        },
        {
            "id": "023986e3-dfd1-4f06-aeb3-bea48c92d927",
            "full_name": "Amir Zaidi",
            "title": "Chief of Staff",
        },
        {
            "id": "9140a3b0-a091-4941-a627-faa5762038cc",
            "full_name": "Alex Titus",
            "title": "Chief Advisor",
        },
        {
            "id": "cde42918-caaf-48a5-abb4-c2226f83a124",
            "full_name": "Meghan Tente",
            "title": "Senior Advisor",
        },
        {
            "id": "7186aa99-f841-4fd4-a26e-a57f79e56d4e",
            "full_name": "Tyler S. Badgley",
            "title": "General Counsel",
        },
        {
            "id": "c297a35b-246d-4ec1-84d9-c45a52ab976a",
            "full_name": "Jennifer Walsh",
            "title": "Deputy Director, Division of Trading and Markets",
        },
        {
            "id": "cc886f0c-e9ac-45cc-86b0-78860c9684b0",
            "full_name": "Rahul Varma",
            "title": "Deputy Director, Products and Market Analytics Branch",
        },
    ],
    "organizations": [
        {
            "id": "300fdad4-5934-48cf-8a56-40f011535c63",
            "name": "Commodity Futures Trading Commission",
            "organization_type": "CFTC office",
        },
        {
            "id": "bfa4314d-d0fb-4437-874d-d938ff33b578",
            "name": "Office of Chairman Selig",
            "organization_type": "Commissioner office",
        },
        {
            "id": "a61d2235-7fdc-48ad-9211-36b3f5971ae5",
            "name": "Office of the General Counsel",
            "organization_type": "CFTC office",
        },
        {
            "id": "bc55503e-e015-4e33-8749-55dd6db0fd72",
            "name": "Division of Clearing and Risk",
            "organization_type": "CFTC division",
        },
        {
            "id": "66ec690a-f7ce-47fc-b0de-f7efd807556a",
            "name": "Division of Market Oversight",
            "organization_type": "CFTC division",
        },
        {
            "id": "8e64944e-aacd-417a-aa5c-e3cf4b6c3d22",
            "name": "Securities and Exchange Commission",
            "organization_type": "Federal agency",
        },
        {
            "id": "d8fc3493-f692-40e9-a039-6ceb3efee539",
            "name": "CME Group",
...
def create_test_db() -> sqlite3.Connection:
            ...
            json.dumps(
                {
                    ...
                    "topics": [
                        {
                            "topic": "Event contract analysis memo",
                            "start_time": 0.0,
                            "end_time": 78.0,
                            "description": "Discussion of the event contract rulemaking analysis memo timeline and OGC review.",
                        },
                        {
                            "topic": "Congressional response on crypto",
                            "start_time": 78.5,
                            "end_time": 118.0,
                            "description": "Overdue congressional response on crypto regulation and need for Chairman sign-off.",
                        },
                        {
                            "topic": "CME comment letter and legal strategy",
                            "start_time": 118.5,
                            "end_time": 205.0,
                            "description": "CME Group's position on event contracts, Loper Bright implications, and interagency coordination with SEC.",
                        },
                        {
                            "topic": "Action items and next steps",
                            "start_time": 205.5,
                            "end_time": 235.0,
                            "description": "Summary of deadlines, assignments, and follow-ups.",
                        },
                    ],
                }
            ),
    ...
    entities = [
        (
            ...
            1,
            2,
            "Referenced in context of court decision on event contracts",
        ),
        (
            "Part 40",
            "regulation",
            ...
            1,
            1,
            "CFTC regulation framework for event contracts",
        ),
        (
            "Meghan Tente",
            "person",
            "cde42918-caaf-48a5-abb4-c2226f83a124",
            None,
            "Meghan Tente",
            0.95,
            1,
            1,
            "Senior Advisor who called about Chairman's briefing request",
        ),
        (
            "Tyler Badgley",
            "person",
            "7186aa99-f841-4fd4-a26e-a57f79e56d4e",
            None,
            "Tyler S. Badgley",
            0.95,
            1,
            1,
            "General Counsel, needs to review legal analysis",
        ),
        (
            "Natasha Robinson",
            "person",
            "f4a43d5a-c9f2-4968-ba2c-ab8de5eec31d",
            None,
            "Natasha Robinson",
            0.90,
            1,
            1,
            "Deputy GC, Legislative Affairs — relayed Hill pressure",
        ),
        (
            "Jennifer Walsh",
            "person",
            "c297a35b-246d-4ec1-84d9-c45a52ab976a",
            None,
            "Jennifer Walsh",
            0.90,
            1,
            1,
            "SEC Deputy Director asking about CFTC timeline",
        ),
        (
            "Rahul Varma",
            "person",
            "cc886f0c-e9ac-45cc-86b0-78860c9684b0",
            None,
            "Rahul Varma",
            0.90,
            1,
            1,
            "DMO analytics, has event contract trading volume data",
        ),
        (
            "CME Group",
            "organization",
            None,
            "d8fc3493-f692-40e9-a039-6ceb3efee539",
            "CME Group",
            0.95,
            1,
            2,
            "Submitted comment letter on event contract authority",
        ),
        (
            "SEC",
            "organization",
            None,
            "8e64944e-aacd-417a-aa5c-e3cf4b6c3d22",
            "Securities and Exchange Commission",
            0.90,
            1,
            2,
            "Watching CFTC event contract timeline",
        ),
        (
            "Senator Warren",
            "person",
            ...
            1,
            1,
            "Staff is impatient about congressional response",
        ),
        (
            "Section 5c(c)(5)(C)",
            "regulation",
            ...
            1,
            1,
            "CEA provision for event contract determination",
        ),
    ]
...
async def run_test():
    ...
    print(
        "    Speakers: Alan Brubaker (Director), Mel Gunewardena (Sr Markets Advisor)"
    )
    print(
        "    Topics: Event contract rulemaking, congressional crypto response, CME comment letter, SEC coordination"
    )
    ...
    print(
        "    Disabled types: decision, status_change, new_matter (per ai_policy.json)"
    )
    ...
    print(
        f"    Speaker person_ids: {len(signals['speaker_person_ids'])} ({', '.join(list(signals['speaker_person_ids'])[:2])})"
    )
    print(f"    Entity person_ids: {len(signals['entity_person_ids'])}")
    print(f"    Entity org_ids: {len(signals['entity_org_ids'])}")
    print(
        f"    Identifier hits: RIN={len(signals['identifier_hits']['rin'])}, Docket={len(signals['identifier_hits']['docket'])}, CFR={len(signals['identifier_hits']['cfr'])}"
    )
    ...
    print(
        f"    Estimated input tokens: ~{(len(system_prompt) + len(user_prompt)) // 4}"
    )
    ...
    for ma in extraction.matter_associations:
        print(
            f"      - {ma.matter_title} (confidence: {ma.match_confidence:.2f}, reason: {ma.match_reason[:80]})"
        )
    print(f"    Bundles: {len(extraction.bundles)}")
    for b in extraction.bundles:
        print(
            f"      - [{b.bundle_type}] {b.target_matter_title or 'standalone'} (conf: {b.confidence:.2f}, items: {len(b.items)})"
        )
        for item in b.items:
            print(
                f"        * {item.item_type}: {item.proposed_data.get('title', item.proposed_data.get('summary', ''))[:60]} (conf: {item.confidence:.2f})"
            )
    print(
        f"    Model-suppressed observations: {len(extraction.suppressed_observations)}"
    )
    for so in extraction.suppressed_observations:
        print(
            f"      - [{so.item_type}] {so.description[:80]} (would-be conf: {so.confidence_if_enabled})"
        )
    ...
    print(
        f"    Invalid references cleaned: {len(pp_log['invalid_references_cleaned'])}"
    )
    ...
    for d in pp_log["dedup_warnings"]:
        print(
            f"      - [{d['item_type']}] proposed: '{d.get('proposed_title', d.get('proposed_summary', ''))[:60]}' vs existing: '{d.get('existing_title', d.get('existing_summary', ''))[:60]}'"
        )
    ...
    for b in bundles:
        print(
            f"      Bundle: [{b.bundle_type}] {b.target_matter_title or 'standalone'} → {len(b.items)} items"
        )
        for item in b.items:
            print(
                f"        - {item.item_type}: {item.proposed_data.get('title', item.proposed_data.get('summary', ''))[:60]}"
            )
    ...
    # Verify DB state
    ext_row = db.execute(
        "SELECT * FROM ai_extractions WHERE id = ?", (extraction_id,)
    ).fetchone()
    print(
        f"    ai_extractions row: model={ext_row['model_used']}, prompt={ext_row['prompt_version']}, tokens={ext_row['input_tokens']}+{ext_row['output_tokens']}"
    )

    bundle_rows = db.execute(
        "SELECT * FROM review_bundles WHERE communication_id = ? ORDER BY sort_order",
        (COMM_ID,),
    ).fetchall()
    print(f"    review_bundles: {len(bundle_rows)} rows")
    for br in bundle_rows:
        print(
            f"      - {br['id'][:8]}... [{br['bundle_type']}] status={br['status']} conf={br['confidence']}"
        )
    ...
    print(
        "    State transition: extracting → awaiting_bundle_review (would be CAS in orchestrator)"
    )
    ...
    for ir in item_rows[:3]:
        locator = (
            json.loads(ir["source_locator_json"]) if ir["source_locator_json"] else {}
        )
        ...
        print(
            f"      speaker: {locator.get('speaker_name')} ({locator.get('speaker_label')})"
        )
    ...
    for b in bundles:
        for item in b.items:
            if item.confidence < 0.70:
                noisy.append(
                    f"LOW CONF ({item.confidence:.2f}): [{item.item_type}] {item.proposed_data.get('title', item.proposed_data.get('summary', ''))[:60]}"
                )
            if (
                item.item_type == "task"
                and not item.proposed_data.get("assigned_to_person_id")
                and not item.proposed_data.get("due_date")
            ):
                noisy.append(
                    f"TASK NO ANCHORS: {item.proposed_data.get('title', '')[:60]}"
                )
    if noisy:
        for n in noisy:
            print(f"    ⚠ {n}")
    ...
    checks = {
        "All items have provenance (source_excerpt)": all(
            ir["source_excerpt"] and len(ir["source_excerpt"]) > 10 for ir in item_rows
        ),
        "All items have source_locator_json": all(
            ir["source_locator_json"] is not None for ir in item_rows
        ),
        "No items below 0.60 confidence": all(
            ir["confidence"] >= 0.60 for ir in item_rows
        ),
        ...
        "All person_ids valid": all(
            json.loads(ir["proposed_data"]).get("assigned_to_person_id") is None
            or json.loads(ir["proposed_data"]).get("assigned_to_person_id")
            in {p["id"] for p in MOCK_TRACKER_CONTEXT["people"]}
            for ir in item_rows
        ),
    ...
    usage_row = db.execute(
        "SELECT * FROM llm_usage WHERE communication_id = ?", (COMM_ID,)
    ).fetchone()
    if usage_row:
        print(
            f"      llm_usage: stage={usage_row['stage']}, model={usage_row['model']}, cost=${usage_row['cost_usd']:.4f}"
        )
    else:
