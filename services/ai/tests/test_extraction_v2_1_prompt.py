...
def test_v2_1_prompt_contains_key_v2_1_invariants():
    ...
    assert 'If Tyler says "I need to ask Rusty," that is Tyler\'s action task.' in prompt
    assert 'If Tyler says "You should ask Rusty," that is a request for Stephen' in prompt
