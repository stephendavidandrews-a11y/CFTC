...
def get_intelligence_by_meeting(meeting_id: str, db=Depends(get_db)):
    ...
    # Parse JSON fields
    json_fields = [
        "decisions_made", "non_decisions", "action_items_summary",
        "risks_surfaced", "briefing_required",
        "key_issues_discussed", "participant_positions",
        "dependencies_surfaced", "commitments_made",
        "recommended_next_move", "materials_referenced", "tags",
    ]
